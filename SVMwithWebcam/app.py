            ...
            with col2:
                ...
                if st.session_state.predictions:
                    ...
                    if recent_preds:
                        ...
                        stats_placeholder.write(f"**Most Recent Common Sign:** {most_common}")
...
def about_mode():
    ...
    **Feature Extraction:**
    ...
    The system recognizes various Arabic alphabet signs including but not limited to:
    - Basic letters (Alif, Ba, Ta, etc.)
    - Common hand shapes and gestures
    
    *Note: The specific gestures depend on your trained model's classes.*
    """)
